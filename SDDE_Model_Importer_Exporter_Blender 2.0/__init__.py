...
class IMPORT_OT_sdde(bpy.types.Operator, ImportHelper):
...
class drag_and_drop_sdde_import(bpy.types.FileHandler):
    bl_idname = "drag_and_drop_sdde_import"
    bl_label = "Import Perm File"
    bl_import_operator = "import_scene.sdde"
    bl_file_extensions = ".bin"
...
def register():
    ...
    bpy.utils.register_class(drag_and_drop_sdde_import)
...
def unregister():
    ...
    bpy.utils.unregister_class(drag_and_drop_sdde_import)
